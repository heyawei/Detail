...
var tb_pathToImage = "images1/loadingAnimation.gif";
...
function tb_show(caption, url, imageGroup) {//function called when the user clicks on a thickbox link
	...
	try {
	   ...
	   var urlType = baseURL.toLowerCase().match(urlString);
		...
		if(urlType == '.jpg' || urlType == '.jpeg' || urlType == '.png' || urlType == '.gif' || urlType == '.bmp'){//code to show images1
			...
			// Resizing large images1 - orginal by Christian Montoya edited by me.
